  ...
  function srcAppServicesApiServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var ApiService = /*#__PURE__*/function () {
      ...
      _createClass(ApiService, [{
        ...
        key: "getQuoteA",
        value: function getQuoteA(author) {
          return this.http.get("https://www.breakingbadapi.com/api/quote?author=".concat(encodeURI(author)));
        }
      }, {
        key: "searchDeath",
        value: function searchDeath(searchname) {
          return this.http.get("https://www.breakingbadapi.com/api/death-count?name=".concat(encodeURI(searchname)));
        }
      }]);
